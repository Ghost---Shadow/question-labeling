...
# python ./src/train.py --config=experiments/cross_model_generalization/gpt35_minilm_kldiv_qd.yaml --debug
python ./src/train.py --config=experiments/cross_model_generalization/gpt35_minilm_kldiv_qd.yaml

# python ./src/train.py --config=experiments/cross_model_generalization/gpt35_minilm_kldiv_ni.yaml --debug
python ./src/train.py --config=experiments/cross_model_generalization/gpt35_minilm_kldiv_ni.yaml
